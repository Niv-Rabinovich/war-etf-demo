...
SECTORS = {
    ...
    "Iran War — חשיפה ישירה 🇮🇷": {
        ...
        "color": "#8b0070",
        "he": "חשיפה ישירה - איראן",
        "desc": "הגנה אווירית (RTX/LMT), אנרגיה (XOM/CVX), סייבר-איראן (CRWD/PANW) — הכי רלוונטיים למלחמת 12 הימים",
    },
}
...
WAR_PERIODS = {
    ...
    "תקיפות ישראל-איראן 2024": {
        "start": "2024-04-13", "end": "2024-10-31",
        "fill": "rgba(130,0,220,0.12)", "line": "rgba(130,0,220,0.6)",
    },
    "מלחמת 12 הימים ישראל-איראן": {
        "start": "2025-06-13", "end": "2025-06-24",
        "fill": "rgba(0,180,255,0.15)", "line": "rgba(0,180,255,0.7)",
    },
}
