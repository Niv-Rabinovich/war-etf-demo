...
st.markdown(f"""
<div class="hero">
    <div class="hero-tag" style="margin:0 0 8px;color:{ACCENT}">◆ קסם תעודות סל</div>
    <div class="hero-title">🛡️ WAR ETF 3x</div>
    <div class="hero-sub">תעודת סל ממונפת ×3 — חשיפה ממוקדת לכלכלת מלחמה</div>
    <div class="hero-tag">הצעה למחלקת המוצרים · קסם תעודות סל</div>
</div>
""", unsafe_allow_html=True)
...
with tab_sim:
    ...
    if len(etf_s) < 5:
        ...
        st.caption("💡 הסימולציה נטו — מניחה השקעה חד-פעמית בתחילת התקופה, ללא הפקדות נוספות.")
...
st.markdown(f"""<div style="text-align:center;color:{MUTED};font-size:12px;padding:8px 0">
    WAR ETF 3x — הצעה לקסם תעודות סל &nbsp;|&nbsp; נתונים: Yahoo Finance · TASE/גלובס<br>
